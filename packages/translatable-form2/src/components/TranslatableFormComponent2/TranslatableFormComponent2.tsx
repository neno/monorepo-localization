...
import { TranslatableFormData2 } from './TranslatableFormComponent2.types';
import { useTranslation } from 'localization';

export function TranslatableFormComponent2() {
  ...
  } = useForm<TranslatableFormData2>();

  const onSubmit = (data: TranslatableFormData2) => console.log(data);
